...
#| label: dag-1-1747
#| echo: false
#| fig-cap: "Simplified Lind's Model"

# DAG showing the 1747 understanding: Lemons → Scurvy Prevention
pgm = daft.PGM(dpi=150, alternate_style="outer")

# Node: Lemons (cause)
pgm.add_node("lemons", "Lemons", 1, 1, aspect=2.5, scale=1.1,
             plot_params={
...
# Node: Scurvy Prevention (effect)
pgm.add_node("scurvy_prevention", "Scurvy\nPrevention", 3, 1, aspect=2.5, scale=1.1,
             plot_params={
...
# DAG showing the misguided belief: Acid → Bacteria Death → Scurvy Prevention (angled layout)
pgm = daft.PGM(dpi=150, alternate_style="outer")

# Node positions on a diagonal: top-left → center → bottom-right
# Acid (cause in the wrong theory)
pgm.add_node("acid", "Acid", 0.5, 1.7, aspect=2.5, scale=1.1,
             plot_params={
                 'facecolor': 'mistyrose',
                 'edgecolor': 'indianred',
                 'linewidth': 2,
...
# Bacteria Death (wrong intermediate mechanism)
pgm.add_node("bacteria_death", "Bacteria\nDeath", 2, 1, aspect=2.5, scale=1.1,
             plot_params={
...
# Scurvy Prevention (effect)
pgm.add_node("scurvy_prevention", "Scurvy\nPrevention", 3.5, 0.3, aspect=2.5, scale=1.1,
             plot_params={
                 'facecolor': 'lightyellow',
...
### DAG 3: The 1928 Understanding — Simplified Modern Understanding (1930s onwards)
...
#| label: dag-3-1928
#| echo: false
#| fig-cap: "Simplified Modern Understanding (1930s onwards)"

# DAG showing the 1928 understanding: Vitamin C → Collagen Synthesis → Scurvy Prevention (angled layout)
pgm = daft.PGM(dpi=150, alternate_style="outer")

# Node positions on a diagonal: top-left → center → bottom-right (like the sample)
# Vitamin C (cause)
pgm.add_node("vitamin_c", "Vitamin C", 0.5, 1.5, aspect=2.5, scale=1.1,
             plot_params={
                 'facecolor': 'lightgreen',
                 'edgecolor': 'darkgreen',
                 'linewidth': 2,
...
# Collagen Synthesis (intermediate mechanism)
pgm.add_node("collagen_synthesis", "Collagen\nSynthesis", 2, 1, aspect=2.5, scale=1.1,
             plot_params={
                 'facecolor': 'lavender',
...
# Scurvy Prevention (effect)
pgm.add_node("scurvy_prevention", "Scurvy\nPrevention", 3.5, 0.5, aspect=2.5, scale=1.1,
             plot_params={
                 'facecolor': 'lightyellow',
                 'edgecolor': 'darkgoldenrod',
                 'linewidth': 2,
